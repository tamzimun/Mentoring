...
//    
//    private var userInfo: MenteeProfile?
...
//
////extension MenteeProfileViewController {
////
...
////    }
////
////    private func loadMenteesList() {
////         //network request
////        networkManager.loadMenteesList() { [weak self] userInfo in
...
//
//
extension MenteeProfileViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            let vc = storyboard?.instantiateViewController(withIdentifier: "EditMenteeViewController")
